\section{Teil 1}
    ...
    \subsection{Zielgruppe}
        ...
        \begin{abstract}
            ...
            Für das Bewerben des alljährlichen Stadtfestes könnte dieser Zeitungsartikel aber genau richtig sein, 
    ...
    \subsection{Kundenzufriedenheit}
        ...
        \begin{abstract}
            ...
            die Qualität der Produkte einfach stark von den Versprechungen abweicht.
            \newline
            Genauso zeigt die Plattform, wie wichtig die eigene Erwartungshaltung
            an das Produkt ist. Jemand der auf die Plattform stößt und bereits 
    ...
    \subsection{Kundennutzen}
        ...
        \begin{abstract}
            ...
            deutlich.
            \newline
            Person A arbeitet bei einem Unternehmen nahe dem eigenen Wohnsitz. Dort 
    ...
    \subsection{Kundenvorteil}
        ...
        \begin{abstract}
            ...
            \newline
            Zu beachten ist dabei, dass der Kundenvorteil nur so klar formuliert werden kann, wenn wirklich 
            alle anderen Komponenten identisch sind. Würde B eine andere Versicherung anbieten, die komplett 
    ...
    \subsection{Marketingstrategie}
        ...
        \begin{abstract}
            ...
            \newline 
            So kann z.B. langfristig festgelegt werden, dass Werbung lediglich online oder offline stattfinden soll.
    ...
    \subsection{Preispolitik}
        ...
        \begin{abstract}
            ...
            \noindent Die Preispolitik ist die Gesamtheit der Maßnahmen, die den Preis bzw. die Zahlungsmethoden 
            eines Produktes beeinflussen.
            \newline
            Ein gutes Beispiel für intensiv betriebene Preispolitik findet man bei jeglichen Internet-Abo-Anbietern.
            Sie bedienen sich an Gratis-Probemonaten, verschiedenen Zahlungsmöglichkeiten (Paypal, Kreditkarte, ...) und
            verschiedenen Abos (monatlich, jährlich) mit unterschiedlichen Kosten bzw. Rabatten für verschiedene Zielgruppen. 
        \end{abstract}
    \subsection{Kommunikationspolitik}
        ...
        \begin{abstract}
            ...
            \newline
            Externe Kommunikationspolitik kann beispielsweise das Einrichten eines FAQ's oder das Schalten 
    ...
    \subsection{Vertriebspolitik}
        ...
        \begin{abstract}
            ...
            \noindent Die Vertriebspolitik umfasst alle Maßnahmen, die den Weg eines Produktes vom Produzenten 
            zum Konsumenten beeinflussen.
            \newline
