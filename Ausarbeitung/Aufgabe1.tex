\section{Teil 1}
    \subsection{Kundenorientierung}
       \subsubsection*{1. Quelle:}
        ...
        \begin{abstract}
            ...
            gehen dabei also über die wirtschaftlichen Kerngrößen hinaus.
            Man könnte von den "Soft Skills" eines Unternehmens sprechen.
            \newline 
            Man stelle sich beispielweise die Vermietung einer Ferienwohnung vor. Die Vermietung
            ...
            Der Kunde wird sich bei seinem nächsten Urlaub in der Nähe der Region garnicht erst
            nach billigeren Alternativen umsehen, wenn die gewphnte noch verfügbar ist, denn es ist 
            nichtmehr nur die Wohneigenschaft, welche erfüllt werden muss um mit der vorherigen Ferienwohnung zu konkurrieren.
        \end{abstract}
    \subsection{Zielgruppe}
        ...
        \begin{abstract}
            ...
            Instrumente des Markeitings anprechen. Es ist die Beantwortung der Frage: "Wer sieht wann wo warum 
            mein Produkt und fördert diese Präsentation mein Produkt?"
            \newline
            Man stelle sich Veranstalter vor, die eine Party für 20-28 Jährige bewerben wollen.
            Logischerweise ist das Schalten einer Anzeige in der Zeitung dafür völlig unpassend.
            Nur wenige der 20-28 Jährigen werden diese Anzeige überhaupt sehen und selbst die, 
            die sie sehen werden den Zeitungsartikel nich mit Partyspaß assoziieren. 
            FÜr das bewerben des alljährigen Stadtfestes könnte dieser Zeitungsartikel aber genau richtig sein, 
            weil dabei eben andere Gruppen angesprochen werden sollen.
            \newline
            Für das Bewerben der Party wäre ein Sozial-Media-Post viel geeigneter. Die Gruppe die erreicht werden 
            soll ist dort viel stärker als Empfänger vertreten. Interesse an der Veranstaltung kann schnell 
    ...
    \subsection{Kundenzufriedenheit}
        ...
        \begin{abstract}
            ...
            \newline
            Ein Beispiel für Kundenzufriedenheit ist die Webplatform wish, die für 
            ...
            "auf wish bestellt" als weit verbrietetes Synonym für qualitativ schlecht 
    ...
    \subsection{Kundennutzen}
        ...
        \begin{abstract}
            ...
            deutlich.
            \newline
            Peroson A arbeitet bei einem Unternehmen nahe des eigenen Wohnsitzes. Dort 
            werden kostenfreie Ladesäulen angeboten. Neben der Fahrt zur Arbeit wird 
    ...
    \subsection{Kundenvorteil}
        ...
        \begin{abstract}
            ...
            Mitwettbewerber. 
            \newline
            Mein betrachte 2 Versicherungsunternehmen, welche identische Lebensverischerungen anbieten.
            Wenn bei Unternehmen A der Versicherungsbeitrag 5\% höher ist als bei Unternehmen B so 
    ...
    \subsection{Marketingstrategie}
        ...
        \begin{abstract}
            ...
            stellung zu lösen, um dadurch die Marketingziele zu erreichen." \cite{Bruhn2019}
        \end{abstract}
        \subsubsection*{Eigene Erläuterung:}
        \begin{abstract}
    ...
    \subsection{Kommunikationspolitik}
        ...
        \begin{abstract}
            ...
            Kommunikationspolitik ist die Gesamtheit aller Mittel, die verwendet werden können um Kunden 
            Produkte zu präsentieren. Weiterhin umfasst sie interne Kommunikationsstrukturen.
            \newline
            Interne Kommunikationspolitik könnte dabei durch Unternehmen z.B. durch regelmäßige Meetings
    ...
    \subsection{Vertriebspolitik}
        ...
        \begin{abstract}
            ...
            faällt unter die Vertiebspolitik.
        \end{abstract}
